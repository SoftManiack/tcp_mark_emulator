...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.15.3"
  WORKING_DIRECTORY "/home/artem/development/c++/tcp_laser_emulator/build/_deps/spdlog-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/artem/development/c++/tcp_laser_emulator/build/_deps/spdlog-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/artem/development/c++/tcp_laser_emulator/build/_deps/spdlog-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
